...
public class VillageDBHelper extends DBHelper {
    ...
    public void insertData(Village villageobj) {
        ...
        database.insert("Village", null, contentValues);
    ...
    public boolean Add(Village village, SQLiteDatabase database1) {
        try {
            ...
            _PopulateLogValues(ex, "Add-VillageDBHelper");
    ...
    public boolean Update(Village village) {
        try {
            ...
            _PopulateLogValues(ex, "Update-VillageDBHelper");
    ...
    public boolean Delete(Integer villageID) {
        try {
            ...
            _PopulateLogValues(ex, "Delete-VillageDBHelper");
    ...
    public boolean DeleteAll() {
        try {
            ...
            _PopulateLogValues(ex, "DeleteAll-VillageDBHelper");
    ...
    public Village Get(int villageID) {
        try {
            ...
            _PopulateLogValues(ex, "Get-VillageDBHelper");
    ...
    public List<Village> GetAll() {
        try {
            ...
            _PopulateLogValues(ex, "GetAll-VillageDBHelper");
    ...
    public List<String> GetDistrict(String state) {
        try {
            ...
            ex.getStackTrace();
            _PopulateLogValues(ex, "GetDistrict-VillageDBHelper");
    ...
    public List<String> GetState() {
        try {
            ...
            ex.getStackTrace();
            _PopulateLogValues(ex, "GetState-VillageDBHelper");
    ...
    public List<String> GetBlock(String district) {
        try {
            ...
            ex.getStackTrace();
            _PopulateLogValues(ex, "GetBlock-VillageDBHelper");
    ...
    public List<VillageList> Getvillages() {
        try {
            ...
            _PopulateLogValues(ex, "GetVillages-VillageDBHelper");
            ex.getStackTrace();
            return null;
        }
    }
    ...
    private Village _PopulateObjectFromCursor(Cursor cursor) {
        try {
            ...
            _PopulateLogValues(ex, "PopulateObjectFromCursor-VillageDBHelper");
    ...
    private List<Village> _PopulateListFromCursor(Cursor cursor) {
        try {
            ...
            _PopulateLogValues(ex, "PopulateListFromCursor-VillageDBHelper");
