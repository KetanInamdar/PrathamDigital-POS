...
import static com.example.pef.prathamopenschool.R.id.gridview;
...
public class CustomAdapter extends BaseAdapter {
    ...
    JSONArray jsnarray;
    EnglishFragment fragment;


    public CustomAdapter(Context context, String noodeList){
...
//        Setting data
        ...
        listViewHolder.rlcard.setOnClickListener(new View.OnClickListener() {
            ...
            CustomAdapter customAdapter = new CustomAdapter(context, nodelist);
