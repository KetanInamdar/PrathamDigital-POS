...
public class UserDBHelper extends DBHelper {
    ...
    public boolean Add(User user) {
        try {
            ...
            _PopulateLogValues(ex, "Add-userDBHelper");
            return false;
        }
    }
    ...
    public boolean Update(User user) {
        try {
            ...
            _PopulateLogValues(ex, "Update-userDBHelper");
            return false;
        }
    }
    ...
    public boolean Delete(String userID) {
        try {
            ...
            _PopulateLogValues(ex, "Delete-userDBHelper");
            return false;
        }
    }
    ...
    public User Get() {
        try {
            ...
            _PopulateLogValues(ex, "Get-userDBHelper");
            return null;
        }
    }
    ...
    public String GetUserNPassword(String username, String password) {
        try {
            ...
            _PopulateLogValues(ex, "GetUserNPassword-userDBHelper");
            return null;
        }
    }
    ...
    public List<User> GetAll() {
        try {
            ...
            _PopulateLogValues(ex, "GetAll-userDBHelper");
            return null;
        }
    }
    ...
    private User _PopulateObjectFromCursor(Cursor cursor) {
        try {
            ...
            _PopulateLogValues(ex, "PopulateObjectFromCursor-userDBHelper");
            return null;
        }
    }
    ...
    private List<User> _PopulateListFromCursor(Cursor cursor) {
        try {
            ...
            _PopulateLogValues(ex, "PopulateListFromCursor-userDBHelper");
            return null;
        }
    }
